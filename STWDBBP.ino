...
String apiKey = "5QM5VMD4YES0KSD4";     //Write API key of your ThingSpeak channel
const char* server = "api.thingspeak.com";  // API for thingspeak
//****************************************************************************************

const char *ssid =  "BlockchainCluster";     // Wifi SSID of your Internet connection
const char *pass =  "Vijay.123"; // Password
