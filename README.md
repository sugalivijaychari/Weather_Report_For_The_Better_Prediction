...
- [Weather-Report-For-The-Better-Prediction](#weather-report-for-the-better-prediction)
- [ABSTRACT](#abstract)
...
- [2: IDENTIFICATION OF THE PROBLEM](#2-identification-of-the-problem)
...
- [3: PRE-ANALYSIS, METHODS, AND TASKS USED TO SOLVE](#3-pre-analysis-methods-and-tasks-used-to-solve)
	...
	- [3.2: Sources of data storage in the existing system:-](#32-sources-of-data-storage-in-the-existing-system-)
	- [3.3: Loopholes in the existing system:-](#33-loopholes-in-the-existing-system-)
	- [3.4: Suitable solution:-](#34-suitable-solution-)
		- [3.4.1: Provide an automated channel to measure, collect and store the data:-](#341-provide-an-automated-channel-to-measure-collect-and-store-the-data-)
		- [3.4.2: Use a decentralized database like Blockchain to protect the data:-](#342-use-a-decentralized-database-like-blockchain-to-protect-the-data-)
	- [3.5: Proposed method:-](#35-proposed-method-)
		- [3.5.1: Measuring values using the Internet of Things:-](#351-measuring-values-using-the-internet-of-things-)
		- [3.5.2: Sending the measured values into a decentralized cloud:-](#352-sending-the-measured-values-into-a-decentralized-cloud-)
		- [3.5.3: Taking the data from cloud to the smart contract using Oraclize technique:-](#353-taking-the-data-from-cloud-to-the-smart-contract-using-oraclize-technique-)
			- [About Oraclize:-](#about-oraclize-)
		- [3.5.4: Storing the collected data in Blockchain:-](#354-storing-the-collected-data-in-blockchain-)
- [4: RESULT, INTERPRETATION OF RESULT AND FUTURE WORK](#4-result-interpretation-of-result-and-future-work)
	- [4.1: Result:-](#41-result-)
	- [4.2: Interpretation of the result:-](#42-interpretation-of-the-result-)
